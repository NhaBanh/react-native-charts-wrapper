//
//  RNRoundCandleStickChartManager.swift
//  Charts
//
...
@objc(RNRoundCandleStickChartManager)
@objcMembers
open class RNRoundCandleStickChartManager: RCTViewManager, RNBarLineChartBaseManager {
  var _bridge: RCTBridge? {get{return self.bridge}}
  
  override open func view() -> UIView! {
    let ins = RNRoundCandleStickChartView()
    return ins;
  }
