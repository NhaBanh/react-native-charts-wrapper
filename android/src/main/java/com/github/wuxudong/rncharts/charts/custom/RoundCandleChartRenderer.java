...
public class RoundCandleChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public RoundCandleChartRenderer(CandleDataProvider chart, ChartAnimator animator,
